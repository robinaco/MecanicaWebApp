...
<h4 class="text-black-50 text-center"><span class="badge badge bg-warning bg-gradient">Actualizar Información Vehiculo:
    {{ $vehiculo->placa }}</span></h4>
<a href="/VehiculesList" class="btn btn-primary btn-sm"><< Atras</a>
<hr>
<div class="card bg-ligth bg-gradient">
    <div class="card-body border border-secondary">
        ...
        <div class="card border border-secondary mb-3" style="padding:1%">
            <form class="row g-3" action="UpdateVehiculo" method="POST">
                @csrf
                @method('PUT')
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label badge  badge  bg-success bg-light">* Marca
                    </label>
                    <select name="marca" id="marca" class="form-control bg-secondary bg-gradient">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control bg-secondary bg-gradient" name="ref" id="ref"
                        value="{{ $vehiculo->referencia }}">
                    @error('ref')<small>* {{ $message }}</small>@enderror
                </div>
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label badge  badge  bg-success bg-light">* Placa</label>
                    <input type="text" class="form-control bg-secondary bg-gradient" id="placa" name="placa"
                        value="{{ $vehiculo->placa }}" min="6" max="7">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control bg-secondary bg-gradient" id="kms" name="kms"
                  ...
                  <div class="col-md-4">
                    <label for="inputEmail4" class="form-label badge  badge  bg-secondary bg-light">*
                        Modelo</label>
                    <select name="modelvh" id="modelvh" class="form-control bg-secondary bg-gradient">
                ...
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label badge  badge  bg-success bg-light">*
                        Color</label>
                    <select name="color" id="color" class="form-control form-control bg-secondary bg-gradient">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="obs" id="obs" cols="30" rows="3"
                        class="form-control bg-secondary bg-gradient">{{ $vehiculo->observaciones }}</textarea>
                    @error('obs')<small>* {{ $message }}</small>@enderror
                </div>
                <div class="card-body">
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-warning btn-sm">Actualizar Informacion</button>
                    </div>
                </div>
